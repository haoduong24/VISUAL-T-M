...
namespace DVH.QLBVot.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHoaDon,MaDonHang,NgayLap,TongTien")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHoaDon,MaDonHang,NgayLap,TongTien")] HoaDon hoaDon)
        {
            if (ModelState.IsValid)
            {
